...
def main():
    ...
    axs1[1, 1].set_title('Boundary Box of Component')
    ...
    axs1[1, 2].set_title('Final image of detection')
    axs1[1, 2].imshow(px_array_gray, cmap='gray')
    rect = Rectangle((bbox_min_x, bbox_min_y), bbox_max_x - bbox_min_x, bbox_max_y - bbox_min_y, linewidth=3,
                     edgecolor='g', facecolor='none')
    axs1[1, 2].add_patch(rect)



    # write the output image into output_filename, using the matplotlib savefig method
    extent = axs1[1, 2].get_window_extent().transformed(fig1.dpi_scale_trans.inverted())
